...
func xorBytes(bytes1: [Byte], bytes2: [Byte]) -> [Byte] {
    return xorBytes(input1: bytes1, input2: bytes2, count: bytes1.count)
}

func xorBytes(input1: UnsafePointer<Byte>,
              offset1: Int,
              input2: UnsafePointer<Byte>,
              offset2: Int,
              output: UnsafeMutablePointer<Byte>,
...
func xorBytes(input1: UnsafePointer<Byte>, input2: UnsafePointer<Byte>, count: Int) -> [Byte] {
    var output = [Byte](repeating: 0, count: count)
    xorBytes(input1: input1, offset1: 0, input2: input2, offset2: 0, output: &output, offset: 0, count: count)
    return output
}
...
func xorWords(input1: UnsafePointer<Byte>,
              offset1: Int,
              input2: UnsafePointer<Byte>,
              offset2: Int,
              output: UnsafeMutablePointer<Byte>,
...
func xorWords(input1: UnsafePointer<Byte>, input2: UnsafePointer<Byte>, count: Int) -> [Byte] {
    var output = [Byte](repeating: 0, count: count * MemoryLayout<Word>.size)
    xorWords(input1: input1, offset1: 0, input2: input2, offset2: 0, output: &output, offset: 0, count: count)
    return output
}
