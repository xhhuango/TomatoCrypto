...
class AesSlowEngineTests: XCTestCase {
    ...
    func testKeySchedule128() {
        ...
        do {
            ...
            let key = SimpleSymmetricKeyParameter(key: stringToBytes(string: key))
            try aes.initialize(isEncryption: true, parameters: [key])
    ...
    func testDecryptBlock128() {
        ...
        do {
            ...
            try aes.initialize(isEncryption: false, parameters: [key])
